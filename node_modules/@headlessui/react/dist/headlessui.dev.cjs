  ...
  constructor(opts) {
    ...
    this.observer = /* @__PURE__ */ (() => {
      ...
      return {
        disconnect: () => {
          var _a3;
          return (_a3 = get()) == null ? void 0 : _a3.disconnect();
        },
        observe: (target) => {
          var _a3;
    ...
    this.notify = (force, sync) => {
      var _a4;
      var _a3, _b2;
      const { startIndex, endIndex } = (_a4 = this.range) != null ? _a4 : {
        startIndex: void 0,
        endIndex: void 0
      };
    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey, enabled }, itemSizeCache) => {
        ...
        for (let i = min2; i < count2; i++) {
          let measureElement2 = (_a3 = this.measurementsCache[i]) == null ? void 0 : _a3.measureElement;
          if (!measureElement2) {
    ...
    this.measure = () => {
      var _a3, _b2;
      this.itemSizeCache = /* @__PURE__ */ new Map();
      (_b2 = (_a3 = this.options).onChange) == null ? void 0 : _b2.call(_a3, this, false);
    };
...
function PortalFn(props, ref) {
  ...
  let render2 = useRender();
  return enabled ? /* @__PURE__ */ import_react53.default.createElement(InternalPortalFn, { ...theirProps, ref: portalRef }) : render2({
...
function ItemsFn(props, ref) {
  ...
  let render2 = useRender();
  return /* @__PURE__ */ import_react73.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, render2({
    ourProps,
    theirProps,
    slot,
